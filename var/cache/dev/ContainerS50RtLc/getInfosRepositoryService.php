 ...
 */
class getInfosRepositoryService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Repository/InfosRepository.php';

        return $container->privates['App\\Repository\\InfosRepository'] = new \App\Repository\InfosRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
