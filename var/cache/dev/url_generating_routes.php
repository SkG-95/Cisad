...
return [
    ...
    'admin_import_csv' => [[], ['_controller' => 'App\\Controller\\CsvImportController::importCsv'], [], [['text', '/admin/import-csv']], [], [], []],
    'app_home' => [[], ['_controller' => 'App\\Controller\\HomeController::index'], [], [['text', '/']], [], [], []],
    'app_infos_index' => [[], ['_controller' => 'App\\Controller\\InfosController::index'], [], [['text', '/infos']], [], [], []],
    'app_infos_new' => [[], ['_controller' => 'App\\Controller\\InfosController::new'], [], [['text', '/infos/new']], [], [], []],
    'app_infos_show' => [['id'], ['_controller' => 'App\\Controller\\InfosController::show'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/infos']], [], [], []],
    'app_infos_edit' => [['id'], ['_controller' => 'App\\Controller\\InfosController::edit'], [], [['text', '/edit'], ['variable', '/', '[^/]++', 'id', true], ['text', '/infos']], [], [], []],
    'app_infos_delete' => [['id'], ['_controller' => 'App\\Controller\\InfosController::delete'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/infos']], [], [], []],
    ...
    'App\Controller\CsvImportController::importCsv' => [[], ['_controller' => 'App\\Controller\\CsvImportController::importCsv'], [], [['text', '/admin/import-csv']], [], [], []],
    'App\Controller\HomeController::index' => [[], ['_controller' => 'App\\Controller\\HomeController::index'], [], [['text', '/']], [], [], []],
    'App\Controller\InfosController::index' => [[], ['_controller' => 'App\\Controller\\InfosController::index'], [], [['text', '/infos']], [], [], []],
    'App\Controller\InfosController::new' => [[], ['_controller' => 'App\\Controller\\InfosController::new'], [], [['text', '/infos/new']], [], [], []],
    'App\Controller\InfosController::show' => [['id'], ['_controller' => 'App\\Controller\\InfosController::show'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/infos']], [], [], []],
    'App\Controller\InfosController::edit' => [['id'], ['_controller' => 'App\\Controller\\InfosController::edit'], [], [['text', '/edit'], ['variable', '/', '[^/]++', 'id', true], ['text', '/infos']], [], [], []],
    'App\Controller\InfosController::delete' => [['id'], ['_controller' => 'App\\Controller\\InfosController::delete'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/infos']], [], [], []],
